...
ALIBABA_JAVA="/usr/sumscope/java/bin/java"
TAOBAO_JAVA="/opt/sumscope/java/bin/java"
if [ -z "$JAVA" ]; then
...
CANAL_OPTS="-DappName=ss-booster-0.0.1-SNAPSHOT"
...
$JAVA $JAVA_OPTS $JAVA_DEBUG_OPT $CANAL_OPTS -classpath .:$class_path com.sumscope.ss.engine.booster.App 1>>/dev/null 2>&1 &
