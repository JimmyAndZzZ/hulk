...
public class ClickHouseConditionParse implements ConditionParse<String> {
    ...
    public String parse(Condition condition, List<Object> param) {
        ...
        String fieldName = new StringBuilder(" ").append(condition.getFieldName()).append(" ").toString();
